...
# I'm building a Magic the Gathering API that will expose some endpoints
- I want to practice the following:
  - OneToOne relations
  - OneToMany relations
  - ManyToMany relations

I also want to go in depth into relations, different parameters etc
...
Once I clearly tell you,
prepare DDL statements for the tables.
I want to use liquibase/flyaway at some point - ignore for now.

# PLAYERS
ID | NICKNAME | NAME | AGE | COUNTRY | POINTS

# CARDS
ID | MTG_ID | NAME | IMAGE_URI | MANA_COST | TYPE | RULES | POWER | TOUGHNESS | COLORS | SET_NAME | RARITY | PRICE_USD

# CARD_PRICES
ID | MTG_ID | DATE | PRICE_USD

# COLLECTIONS
PLAYER_ID | CARD_MTG_ID | QUANTITY
...
# GAMES_PLAYERS
ID | GAME_ID | PLAYER_1_ID | PLAYER_2_ID | ROUND | RESULT | TIME_TAKEN
